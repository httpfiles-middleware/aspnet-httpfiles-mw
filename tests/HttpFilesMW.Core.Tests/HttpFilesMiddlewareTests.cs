...
public class HttpFilesMiddlewareTests
{
    ...
    private readonly Mock<IHttpFileGenerator> mockGenerator;
    ...
    public HttpFilesMiddlewareTests()
    {
        ...
        this.mockGenerator = new Mock<IHttpFileGenerator>();
    ...
    //    this.mockGenerator.Setup(m => m.GenerateAsync()).ReturnsAsync("You requested the file at path: ");
